...
`;
  ...
  try {
    ...
    console.error('\n❌ AI処理エラー:', error);
    // GitHub ActionsのSummary画面に警告として表示させるための特殊フォーマット（プロセスは停止しない）
...
async function main() {
  ...
  console.log('::notice title=AI Model Info::Running with [gemini-1.5-flash-latest] for monitoring and stability');
  try {
